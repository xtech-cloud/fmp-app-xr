...
namespace XTC.FMP.APP.XR
{
    ...
    public class XPointerGraphicRaycaster : XBasePointerRaycaster
    {
        ...
        protected XPointerGraphicRaycaster()
        {
        }
        ...
        private Camera GetCameraForRaycastMode(XBasePointer pointer, XBasePointer.RaycastMode mode)
        {
            switch (mode)
            {
                case XBasePointer.RaycastMode.Direct:
                    ...
                    {
                        Transform pointerTransform = XPointerInputModule.Pointer.PointerTransform;
        ...
        private Camera AddDummyCameraToPointer(XBasePointer pointer)
        {
