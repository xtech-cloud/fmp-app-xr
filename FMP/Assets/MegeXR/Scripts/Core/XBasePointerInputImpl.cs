            ...
            else
            {
                ...
                if (previousObject != null || (currentObject == null && isPointerHovering))
                {
                    if (pointerIsActiveAndAvailable)
                    {
                        ...
                        if (Pointer.OnPointerExitCallback != null)
                            Pointer.OnPointerExitCallback.Invoke(Pointer, previousObject);
                    }
                ...
                if (currentObject != null)
                {
                    if (pointerIsActiveAndAvailable)
                    {
                        ...
                        if (Pointer.OnPointerEnterCallback != null)
                            Pointer.OnPointerEnterCallback.Invoke(Pointer, CurrentEventData.pointerCurrentRaycast);
                    }
